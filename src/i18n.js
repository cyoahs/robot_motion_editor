...
const translations = {
  zh: {
    ...
    ikTuning: '求解参数（权重 0~1）',
    ikTuningPosition: '位置拖拽',
    ikTuningOrientation: '姿态拖拽',
    ikMaxIter: '迭代',
    ikDamping: '阻尼',
    ikClamp: '步长上限',
    ikDiverge: '发散阈值',
    ikPosTol: '位置容差(m)',
    ikEndPasses: '松手加强迭代×',
    ikTuningHint: '拖拽时每帧仅求解 1 次；T/R 权重范围 [0,1]。',
  ...
  en: {
    ...
    ikTuning: 'Solver params (weights 0–1)',
    ikTuningPosition: 'Position drag',
    ikTuningOrientation: 'Orientation drag',
    ikMaxIter: 'Iterations',
    ikDamping: 'Damping',
    ikClamp: 'Step clamp',
    ikDiverge: 'Diverge threshold',
    ikPosTol: 'Pos tolerance (m)',
    ikEndPasses: 'Release boost iter×',
    ikTuningHint: 'One IK solve per drag frame; T/R weights in [0,1].',

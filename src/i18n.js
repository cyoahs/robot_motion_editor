...
const translations = {
  zh: {
    ...
    loadCSV: '加载 CSV 轨迹',
    loadRobotURDF: '机器人 URDF',
    loadRobotTrajectory: '机器人轨迹',
    loadSceneURDF: '场景 URDF',
    loadSceneTrajectory: '场景轨迹',
    addRobot: '添加机器人',
    uploadURDF: '上传 URDF',
    unitreeRobots: 'Unitree',
    builtinG1: 'G1',
    builtinH2: 'H2',
    uploadScene: '上传场景',
    optimizeMeshOnUpload: '优化上传 Mesh',
    optimizeMeshOnUploadTitle: '上传机器人或场景 URDF 时自动减少 Mesh 面数',
    optimizeMeshOnUploadDesc: '上传机器人或场景时，在浏览器本地降低高面数 Mesh 的复杂度。',
    loadingBuiltinRobot: '正在加载内置 {robot}...',
    builtinRobotLoadSuccess: '内置 {robot} 加载成功',
    builtinRobotLoadFailed: '内置 {robot} 加载失败',
    optimizingMeshes: '正在优化 {model} Mesh ({current}/{total})...',
    export: '导出数据',
    project: '工程文件',
    exportTrajectory: '导出编辑轨迹',
    exportBaseTrajectory: '导出原始轨迹',
    robotTrajectoryGroup: '机器人轨迹',
    sceneTrajectoryGroup: '场景轨迹',
    exportRobotTrajectory: '导出机器人编辑轨迹',
    exportRobotBaseTrajectory: '导出机器人原始轨迹',
    exportSceneTrajectory: '导出场景编辑轨迹',
    exportSceneBaseTrajectory: '导出场景原始轨迹',
    exportVideo: '导出视频',
    stopRecording: '停止录制',
    loadProject: '加载工程文件',
    saveProject: '保存工程文件',
    ...
    compareMode: '比较模式',
    createMode: '创建模式',
    createModeSettings: '创建轨迹',
    trajectoryTarget: '编辑对象',
    robot: '机器人',
    scene: '场景',
    frameCount: '帧数',
    createZeroTrajectory: '创建零轨迹',
    applyTrajectoryLength: '应用长度',
    ...
    editRobot: '机器人编辑',
    editScene: '场景编辑',
    robotJointControl: '机器人关节控制',
    sceneJointControl: '场景自由度',
    sceneFixHint: '勾选 Fix 后，该自由度会在整条轨迹中保持当前设定值。',
    fixDOF: 'Fix',
    fix: 'Fix',
    fixJointTitle: '将此自由度固定为当前值，并应用到整条轨迹',
    reset: '重置',
    alignLowest: '平移对齐',
    ...
    needRobot: '请先加载机器人模型',
    needScene: '请先加载场景模型',
    emptyTrajectory: '轨迹中没有可用帧',
    loadingSceneURDFFolder: '正在加载场景 URDF 文件夹...',
    robotModelCreateFailed: '无法创建机器人模型',
    sceneModelCreateFailed: '无法创建场景模型',
    sceneUrdfLoadFailed: '场景 URDF 加载失败',
    sceneUnitreeOnly: '场景轨迹目前仅支持 unitree 格式',
    setTrajectoryFPS: '请输入轨迹 FPS:',
    trajectoryClearedJointMismatch: '轨迹自由度数量与模型不匹配，已清除原轨迹',
    ...
    projectNeedsModels: '工程轨迹已加载；请重新导入对应的 {models} URDF 模型。',
    ...
    robotUrdfLoadSuccess: '机器人 URDF 加载成功 (自由度数: {count})',
    sceneUrdfLoadSuccess: '场景 URDF 加载成功 (自由度数: {count})',
    robotUrdfOptimizedLoadSuccess: '机器人 URDF 加载成功 (自由度数: {count}，Mesh {before} → {after} 面)',
    sceneUrdfOptimizedLoadSuccess: '场景 URDF 加载成功 (自由度数: {count}，Mesh {before} → {after} 面)',
    trajectoryJointCountMismatch: '轨迹自由度数量不匹配（模型: {expected}，轨迹: {actual}）',
    zeroTrajectoryCreated: '已创建零轨迹（{frames} 帧，{fps} FPS）',
    trajectoryLengthUpdated: '轨迹长度已更新（{frames} 帧，{fps} FPS）',
    trajectoryExported: '轨迹已导出',
    baseTrajectoryExported: '原始轨迹已导出',
    sceneTrajectoryExported: '场景编辑轨迹已导出',
    sceneBaseTrajectoryExported: '场景原始轨迹已导出',
    ...
    helpStep2: '加载轨迹：支持 unitree CSV（base xyz + 四元数 xyzw + 关节弧度）和 seed CSV（Frame + cm/degree），会自动转换',
  ...
  en: {
    ...
    loadRobotURDF: 'Robot URDF',
    loadRobotTrajectory: 'Robot Trajectory',
    loadSceneURDF: 'Scene URDF',
    loadSceneTrajectory: 'Scene Trajectory',
    addRobot: 'Add Robot',
    uploadURDF: 'Upload URDF',
    unitreeRobots: 'Unitree',
    builtinG1: 'G1',
    builtinH2: 'H2',
    uploadScene: 'Upload Scene',
    optimizeMeshOnUpload: 'Optimize uploaded meshes',
    optimizeMeshOnUploadTitle: 'Automatically reduce mesh face counts when uploading a robot or scene URDF',
    optimizeMeshOnUploadDesc: 'Reduce high-poly robot or scene meshes locally in your browser during upload.',
    loadingBuiltinRobot: 'Loading built-in {robot}...',
    builtinRobotLoadSuccess: 'Built-in {robot} loaded successfully',
    builtinRobotLoadFailed: 'Failed to load built-in {robot}',
    optimizingMeshes: 'Optimizing {model} meshes ({current}/{total})...',
    export: 'Export Data',
    project: 'Project Files',
    exportTrajectory: 'Export Edited Trajectory',
    exportBaseTrajectory: 'Export Base Trajectory',
    robotTrajectoryGroup: 'Robot Trajectory',
    sceneTrajectoryGroup: 'Scene Trajectory',
    exportRobotTrajectory: 'Export Edited Robot Trajectory',
    exportRobotBaseTrajectory: 'Export Base Robot Trajectory',
    exportSceneTrajectory: 'Export Edited Scene Trajectory',
    exportSceneBaseTrajectory: 'Export Base Scene Trajectory',
    ...
    createModeSettings: 'Create Trajectory',
    trajectoryTarget: 'Edit Target',
    robot: 'Robot',
    scene: 'Scene',
    frameCount: 'Frames',
    createZeroTrajectory: 'Create Zero Trajectory',
    applyTrajectoryLength: 'Apply Length',
    ...
    localProcessingSettings: 'Local Processing',
    autoSave: 'Auto Save',
    ...
    robotJointControl: 'Robot Joint Control',
    sceneJointControl: 'Scene DOFs',
    sceneFixHint: 'When Fix is enabled, this DOF keeps its configured value for the entire trajectory.',
    fixDOF: 'Fix',
    fix: 'Fix',
    fixJointTitle: 'Hold this DOF at its current value for the entire trajectory',
    reset: 'Reset',
    ...
    needScene: 'Please load the scene model first',
    emptyTrajectory: 'The trajectory contains no usable frames',
    loadingSceneURDFFolder: 'Loading scene URDF folder...',
    robotModelCreateFailed: 'Failed to create the robot model',
    sceneModelCreateFailed: 'Failed to create the scene model',
    sceneUrdfLoadFailed: 'Failed to load the scene URDF',
    sceneUnitreeOnly: 'Scene trajectories currently support only the unitree format',
    setTrajectoryFPS: 'Enter trajectory FPS:',
    trajectoryClearedJointMismatch: 'The trajectory DOF count does not match the model, so the trajectory was cleared',
    ...
    projectNeedsModels: 'The project trajectories are loaded; please import the corresponding {models} URDF models again.',
    ...
    addMetadata: 'Add video metadata',
    keepTabVisible: 'Keep this tab in foreground<br>Switching tabs will pause export',
    ...
    robotUrdfLoadSuccess: 'Robot URDF loaded successfully (DOFs: {count})',
    sceneUrdfLoadSuccess: 'Scene URDF loaded successfully (DOFs: {count})',
    robotUrdfOptimizedLoadSuccess: 'Robot URDF loaded (DOFs: {count}, mesh faces {before} → {after})',
    sceneUrdfOptimizedLoadSuccess: 'Scene URDF loaded (DOFs: {count}, mesh faces {before} → {after})',
    trajectoryJointCountMismatch: 'Trajectory DOF count mismatch (model: {expected}, trajectory: {actual})',
    zeroTrajectoryCreated: 'Created a zero trajectory ({frames} frames at {fps} FPS)',
    trajectoryLengthUpdated: 'Updated trajectory length ({frames} frames at {fps} FPS)',
    trajectoryExported: 'Trajectory exported',
    baseTrajectoryExported: 'Base trajectory exported',
    sceneTrajectoryExported: 'Edited scene trajectory exported',
    sceneBaseTrajectoryExported: 'Base scene trajectory exported',
    ...
    helpStep2: 'Load Trajectory: Supports unitree CSV (base xyz + quaternion xyzw + joint radians) and seed CSV (Frame + cm/degrees), converted automatically',
